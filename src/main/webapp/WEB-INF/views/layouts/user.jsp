	...
	<div class="container">
		...
		<header id="header">
			<div class="row">
				<div class="span4">
					<h1>
						<a class="logo" href="index.html"><span style="color: red;">Mobile Store</span> 
				...
				<div class="span4">
					<div class="offerNoteWrapper">
						<h1 class="dotmark">
							<i class="icon-cut"></i> Mobile Store is available @ $14
						</h1>
					</div>
				</div>
...
-->
		<div class="row">
			<div id="sidebar" class="span3">
				...
				<div class="well well-small">
					<a href="#">					
					<img src="<c:url value="/assets/user/img/paypal.jpg" />" alt="payment method paypal" />
					</a>
				</div>
					...
					<li>
						<div class="thumbnail">
							<a class="zoomTool" href="product_details.html"
								...
								<img src="<c:url value="/assets/user/img/bootstrap-ecommerce-templates.jpg" />" 
					...
					<li>
						<div class="thumbnail">
							<a class="zoomTool" href="product_details.html"
								...
								<img src="<c:url value="/assets/user/img/shopping-cart-template.jpg" />" 
									...
									<ul class="thumbnails">
										...
										<li class="span3">
											<div class="thumbnail">
												<a class="zoomTool" href="product_details.html"
													...
													<img style="width: 100%"
													 src="<c:url value="/assets/user/img/i.jpg" />" 
														alt="bootstrap-ring" />
													</a>
											</div>
										</li>
										<li class="span3">
											<div class="thumbnail">
												<a class="zoomTool" href="product_details.html"
													...
													<img style="width: 100%"
													 src="<c:url value="/assets/user/img/g.jpg" />" 
														alt="bootstrap-ring" />
													</a>
											</div>
										</li>
										<li class="span3">
											<div class="thumbnail">
												<a class="zoomTool" href="product_details.html"
													title="add to cart"><span class="icon-search"></span>
													QUICK VIEW</a> <a href="product_details.html">											
													<img style="width: 100%"
										...
										<li class="span3">
											<div class="thumbnail">
												<a class="zoomTool" href="product_details.html"
													...
													<img style="width: 100%"
													 src="<c:url value="/assets/user/img/f.jpg" />" 
														alt="bootstrap-ring" />
													</a>
											</div>
										</li>
										<li class="span3">
											<div class="thumbnail">
												<a class="zoomTool" href="product_details.html"
													...
													<img style="width: 100%"
													 src="<c:url value="/assets/user/img/h.jpg" />" 
														alt="bootstrap-ring" />
													</a>
											</div>
										</li>
										<li class="span3">
											<div class="thumbnail">
												<a class="zoomTool" href="product_details.html"
													...
													<img style="width: 100%"
													 src="<c:url value="/assets/user/img/j.jpg" />" 
														alt="bootstrap-ring" />
													</a>
											</div>
										</li>
							...
							<li class="span4">
								<div class="thumbnail">
									...
									<a class="zoomTool" href="product_details.html"
										...
										<img style="width: 100%"
											 src="<c:url value="/assets/user/img/b.jpg" />" 
											alt="bootstrap-ring" />
										</a>
							...
							<li class="span4">
								<div class="thumbnail">
									<a class="zoomTool" href="product_details.html"
										...
										<img style="width: 100%"
											 src="<c:url value="/assets/user/img/c.jpg" />" 
											alt="bootstrap-ring" />
										</a>
									<div class="caption cntr">
										<p>Manicure & Pedicure</p>
							...
							<li class="span4">
								<div class="thumbnail">
									<a class="zoomTool" href="product_details.html"
										...
										<img style="width: 100%"
											 src="<c:url value="/assets/user/img/a.jpg" />" 
											alt="bootstrap-ring" />
										</a>
									<div class="caption cntr">
										<p>Manicure & Pedicure</p>
							...
							<li class="span4">
								<div class="thumbnail">
									<a class="zoomTool" href="product_details.html"
										...
										<img style="width: 100%"
											 src="<c:url value="/assets/user/img/d.jpg" />" 
											alt="" />
										</a>
									<div class="caption">
							...
							<li class="span4">
								<div class="thumbnail">
									<a class="zoomTool" href="product_details.html"
										...
										QUICK VIEW</a> <a href="product_details.html">
										<img style="width: 100%"
											 src="<c:url value="/assets/user/img/e.jpg" />" 
											alt="" />
...
-->
		<section class="our_client">
			...
			<div class="row">
				<div class="span2">
					<a href="#">
						<img src="<c:url value="/assets/user/img/1.png" />" />
					</a>
				</div>
				<div class="span2">
					<a href="#">
						<img src="<c:url value="/assets/user/img/2.png" />" />		
					</a>
				</div>
				<div class="span2">
					<a href="#"><img src="<c:url value="/assets/user/img/3.png" />" /></a>
				</div>
				<div class="span2">
					<a href="#"><img src="<c:url value="/assets/user/img/4.png" />" /></a>
				</div>
				<div class="span2">
					<a href="#"><img src="<c:url value="/assets/user/img/5.png" />" /></a>
				</div>
				<div class="span2">
					<a href="#"><img src="<c:url value="/assets/user/img/6.png" />" /></a>
				</div>
			</div>
		</section>
...
-->
	...
	<div class="copyright">
		<div class="container">
			<p class="pull-right">
				<a href="#">
					<img src="<c:url value="/assets/user/img/maestro.png" />" />
					
				</a>
				<a href="#"><img src="<c:url value="/assets/user/img/mc.png"/>" alt="payment"  /></a> 
				<a
					href="#"><img src="<c:url value="/assets/user/img/pp.png"/>"  alt="payment"  /></a> 
				<a
					href="#"><img src="<c:url value="/assets/user/img/visa.png" />"  alt="payment" /></a> 
				<a
					href="#"><img src="<c:url value="/assets/user/img/disc.png"/>" alt="payment"  /></a>
			</p>
			<span style="color: red">Copyright &copy; 2023<br> VO THI KIM TRANG.
			</span>
		</div>
	</div>
